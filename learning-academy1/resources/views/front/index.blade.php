    ...
    <section class="member_counter">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{$trainerCount}}</span>
                        <h4>trainers</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                ...
                @foreach($Courses as $c)
                    ...
                    <div class="single_special_cource">
                        ...
                        <div class="special_cource_text">
                            <a href="{{route('front.course',$c->cat->id)}}" class="btn_4">{{$c->cat->name}}</a>
                            <h4>{{$c->price}}</h4>
                            <a href="{{route('front.show',[$c->id,$c->cat->id])}}"><h3>{{$c->name}}</h3></a>
                            <p>{{$c->smalldesc}}</p>
